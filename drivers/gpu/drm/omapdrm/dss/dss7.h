...
extern const u16 *omapdss_regmap;

#define REG(r) (omapdss_regmap[r ## _OFF])
...
#define DISPC_VID_DMA_BUFSIZE		0x2bc /* J7 */

/* OVR */

#define DISPC_OVR_CONFIG		0x0
#define DISPC_OVR_VIRTVP		0x4 /* J7 */
...
#define DISPC_VP_DSS_MERGE_SPLIT		0x16c /* J7 */
#define DISPC_VP_DSS_DMA_THREADSIZE		0x170 /* J7 */
#define DISPC_VP_DSS_DMA_THREADSIZE_STATUS	0x174 /* J7 */
