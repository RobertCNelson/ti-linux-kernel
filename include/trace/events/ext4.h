...
TRACE_EVENT(ext4_sync_file_enter,
	...
	TP_fast_assign(
		...
		__entry->dev		= fs_inode(dentry)->i_sb->s_dev;
		__entry->ino		= fs_inode(dentry)->i_ino;
		__entry->datasync	= datasync;
		__entry->parent		= fs_inode(dentry->d_parent)->i_ino;
	),
...
TRACE_EVENT(ext4_unlink_enter,
	...
	TP_fast_assign(
		...
		__entry->size		= fs_inode(dentry)->i_size;
	),
