	...
	size_t size, int type)
{
	...
	return squashfs_xattr_get(fs_inode(d), SQUASHFS_XATTR_USER, name,
		buffer, size);
}
	...
	void *buffer, size_t size, int type)
{
	...
	return squashfs_xattr_get(fs_inode(d), SQUASHFS_XATTR_TRUSTED, name,
		buffer, size);
}
	...
	void *buffer, size_t size, int type)
{
	...
	return squashfs_xattr_get(fs_inode(d), SQUASHFS_XATTR_SECURITY, name,
		buffer, size);
}
